...
public class MTFView extends RelativeLayout implements BottomBarCallback,PairMaker{
    ...
    private ArrayList<DataPairs> dataPairsArrayList;
    ...
    public void setQuestionRecycler(RecyclerView recycler,MtfAdapter adapter){
    ...
    public void makePairs(View v,View v2,int pos1,int pos2){
        DataPairs dataPairs=new DataPairs(this.mAdapter1.getElementAt(pos1),this.mAdapter2.getElementAt(pos2),
                v.getTag().toString(),v2.getTag().toString());
